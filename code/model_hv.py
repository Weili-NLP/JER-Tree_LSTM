    ...
    def build(self,
        ...
        if word_dim:
            ...
            if pre_emb and training:
                ...
                '''
                pretrained = word2vec.Word2Vec.load_word2vec_format(pre_emb, binary=True)
                c_found = 0
                c_lower = 0
                c_zeros = 0
                ...
                print 'Loaded %i pretrained embeddings.' % len(pretrained.vocab)
        ...
        return f_train, f_eval, f_eval_softmax, f_eval_hv
