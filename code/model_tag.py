...
class Model(object):
    ...
    def save_mappings(self, id_to_word, id_to_char, id_to_tag, id_to_POS, id_to_N, id_to_V):
        """
        ...
        if self.parameters['dep_dim']:
            self.id_to_V = id_to_V
            self.id_to_N = id_to_N
        with open(self.mappings_path, 'wb') as f:
            ...
            if self.parameters['dep_dim']:
                mappings['id_to_N'] = self.id_to_N
                mappings['id_to_V'] = self.id_to_V
    ...
    def build(self,
        ...
        if training:
            ...
            f_train = theano.function(
                inputs=train_inputs,
                outputs=[cost,real_path_score,all_paths_scores],
                updates=updates,
